 ...
 */
public class ListAdapter extends AbsBaseAdapter<Product.DataBean.ProductsBean> {
    ...
    public ListAdapter(Context context, List<Product.DataBean.ProductsBean> data) {
        super(context, data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.ltem_gridlist, null);
